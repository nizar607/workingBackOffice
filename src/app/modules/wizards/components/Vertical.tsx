            ...
            <div className='stepper-item current' data-kt-stepper-element='nav'>
              ...
              <div className='stepper-wrapper'>
                ...
                <div className='stepper-label'>
                  ...
                  <div className='stepper-desc fw-semibold'>Setup Tourament (logo , Name , Age Range )</div>
                </div>
                {/* end::Label*/}
              </div>
              {/* end::Wrapper*/}
            ...
            <div className='stepper-item' data-kt-stepper-element='nav'>
              ...
              <div className='stepper-wrapper'>
                ...
                <div className='stepper-label'>
                  ...
                  <div className='stepper-desc fw-semibold'>Setup Tournament ( Location  , Date  , Sexe)</div>
                </div>
                {/* end::Label*/}
              </div>
              {/* end::Wrapper*/}
